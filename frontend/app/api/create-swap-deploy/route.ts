 ...
 * This produces the "Deploy" format that CSPR.click expects
 */
export async function POST(request: NextRequest) {
  try {
    ...
    // Create module bytes session (wasm deploy) - SDK v2.15.5 format
    ...
    // Convert to JSON - use the same format as working deploys
